# Now it's time to have some fun with strings. The starting code includes 6 steps for you take to practice what you've learned
...
print(""" Creating my own multiline code for the sake
of this assignment. """)
