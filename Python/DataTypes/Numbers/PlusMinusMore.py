# Now it's time to explore numbers in Python: int and float. Follow the directions provided in the starting code. In total,
# you should add 14 print commands to complete this activity.
