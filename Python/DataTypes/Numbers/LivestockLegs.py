...
# species, chickens have two legs, cows have four legs, and pigs have four legs. The farmer has counted his animals and he gives you
# a subtotal for each species. You have to implement a function that returns the total number of legs of all the animals.
