# It's time to practice writing a while loop in Python. As you've seen, the syntax is similar to JavaScript, except using : at the end of the
# loop definition and indentation for the block of code to run with that loop.

# Write a while loop to calculate the total number of pennies resulting from each doubling. End the loop when the value is
