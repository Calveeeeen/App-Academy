# In Python, lambda functions work as anonymous functions that evaluates to a single expression. You could say it's a
# little more petite than its JavaScript counterpart.
