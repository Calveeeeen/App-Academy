...
describe("isFive(num)", () => {
  it("should return true if the num is 5 otherwise false", () => { //testing if the number enter is === 5;
    const num1 = 5;
...
describe("isOdd(number)", () => {
  it("should return true if number is odd", () => { //testing to see if the number entered is odd.
    const num1 = 3;
    const num2 = 2953;
    const num3 = -999;
  ...
  it("should return false if the num is even", () => { //testing if the number is even it will return false
    const num1 = 4;
    const num2 = 2952;
    const num3 = -998;
  ...
  it("should throw an error if num is not type of Number", () => { //testing if anything other than a number is entered it will return an error;
...
describe("myRange(min, max, step)", () => {
  context("if step is not provided", () => {
    it("should return the correct array with default value step=1", () => { //testing if statments that if step parameter is undefined it will default to 1. and return the correct array accordingly.
      const [min1, max1] = [0, 5];
      const [min2, max2] = [6, 3];
  ...
  context("if step is provided", () => {
    it("should return the correct array", () => {//if the step parameter is defined then the array returned should follow the steps provided.
